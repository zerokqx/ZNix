{ pkgs, inputs, ... }:
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    usbutils
    exfat
    ntfs3g # если используете NTFS-флешки
    udiskie
    xfce.thunar
    xfce.thunar-volman # монтирование USB/дисков
    xfce.tumbler
    xfce.thunar-archive-plugin # архивы (zip, tar и т.д.)
    # Опционально: превью изображений и видео
    prismlauncher
    antigravity
    alacritty
